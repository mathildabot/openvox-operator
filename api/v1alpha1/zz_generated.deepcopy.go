...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerCASpec) DeepCopyInto(out *ServerCASpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerCASpec.
func (in *ServerCASpec) DeepCopy() *ServerCASpec {
	if in == nil {
		return nil
	}
	out := new(ServerCASpec)
	in.DeepCopyInto(out)
	return out
}
